  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" class="package">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="套餐名称" prop="service_name">
          <el-input v-model="dataForm.service_name" />
        </el-form-item>
        <el-form-item label="套餐价格" prop="sellprice">
          <el-input v-model="dataForm.sellprice" />
        </el-form-item>
        <el-form-item label="服务列表 " prop="service_type" style="width:600px">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        service_name: [{ required: true, message: '套餐名称不能为空', trigger: 'blur' }]
      }
    }
  },
  computed: {
